				...
				function loadFullImage(item, i) {
					...
					function addedImg() {
						...
						requestAnimationFrame(function() {
							...
							var $masonry = jQuery(item).parents('.view-masonry .gallery-images, .grid-masonry');
							if( $masonry.length > 0 ) {
...
(function($) {
    ...
    woodmartThemeModule.loginSidebar = function() {
        ...
        var closeWidget = function() {
            body.removeClass( 'woodmart-login-side-opened' );
        };

        var openWidget = function() {
            body.addClass( 'woodmart-login-side-opened' );
        };
        
        var isOpened = function() {
            return body.hasClass( 'woodmart-login-side-opened' );
        };
    };
    ...
    */
    ...
    woodmartThemeModule.shopHiddenSidebar = function() {
