    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            array(
                ...
                'desc'     => esc_html__('If you enable this option, then you will be able to configure your header layout, styles and options in the Header Builder section in your Dashboard. Note that all options for Header in Theme Settings will be ignored.', 'woodmart'),
                "default"   => false
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array (
            array (
                'id'       => 'dummy_import',
                'type'     => 'switch',
                'title'    => esc_html__('Enable Dummy Content section', 'woodmart'),
                'default' => true
            ),
        ),
    ) );
