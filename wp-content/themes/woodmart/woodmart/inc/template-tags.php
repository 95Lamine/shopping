	...
	function woodmart_main_loop() {
		...
		?>
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php if ( ! $is_ajax ): ?>
					<div class="woodmart-blog-holder <?php if( $blog_design == 'masonry' ): ?>masonry-container<?php endif ?> blog-pagination-<?php echo esc_attr( $pagination ); ?>" data-paged="1" data-source="main_loop">
				<?php endif ?>
...
if( ! function_exists( 'woodmart_owl_carousel_init' ) ) {
	function woodmart_owl_carousel_init( $atts = array() ) {
		...
		$func_name = function() use( $carousel_id, $slides_per_view, $autoplay, $autoheight, $speed, $hide_pagination_control, $hide_prev_next_buttons, $scroll_per_page, $wrap, $dragEndSpeed, $custom_sizes, $center_mode ) {
