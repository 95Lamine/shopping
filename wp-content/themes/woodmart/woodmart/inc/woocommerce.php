...
if( ! function_exists( 'woodmart_product_brand_tab' ) ) {
	function woodmart_product_brand_tab( $tabs ) {
		...
		$show_tab = false;
		$brand_title = esc_html__( 'brand', 'woodmart' );
...
if( ! function_exists( 'woodmart_setup_loop' ) ) {
	...
	add_action( 'woocommerce_before_shop_loop', 'woodmart_setup_loop' );
	add_action( 'wp', 'woodmart_setup_loop' );
	add_action( 'loop_start', 'woodmart_setup_loop' );
}
