            ...
            <div class="rp-row support-tabs">
                <div class="rp-col">
                    <div class="support-item">
                        ...
                        <a target="_blank"
                           href="<?php echo esc_url( 'http://help.kutethemes.net/docs/kuteshop-3-0/' ); ?>"
                ...
                <div class="rp-col closed">
                    <div class="support-item">
                        ...
                        <a href="<?php echo esc_url( 'https://www.youtube.com/watch?v=Vq6nMIyj3gg&feature=youtu.be' ) ?>" target="_blank"
